...
public class VideoPlayerConfig {
    ...
    public static final String DEFAULT_VIDEO_URL1 = "https://archive.org/download/ksnn_compilation_master_the_internet/ksnn_compilation_master_the_internet_512kb.mp4";
}
