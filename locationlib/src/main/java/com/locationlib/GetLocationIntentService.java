...
public class GetLocationIntentService extends IntentService {
    ...
    private static final String IDENTIFIER = "GetLocationIntentService";
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if (addressResultReceiver == null) {
            Log.e("GetLocationIntent","No receiver, not processing the request further");
            return;
        }
        ...
        try {
            ...
            Log.e("GetLocationIntent","Error in getting address for the location");
        }
